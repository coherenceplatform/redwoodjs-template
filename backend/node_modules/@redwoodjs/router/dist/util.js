...
exports.getFocus = exports.getAnnouncement = void 0;
exports.isReactElement = isReactElement;
exports.isSpec = isSpec;
exports.matchPath = void 0;
exports.normalizePage = normalizePage;
exports.validatePath = exports.resetFocus = exports.replaceParams = exports.parseSearch = exports.paramsForRoute = void 0;
...
const replaceParams = function (route) {
  ...
  (0, _forEach.default)(params).call(params, param => {
    ...
    if (value !== undefined) {
      ...
      throw new Error((0, _concat.default)(_context4 = "Missing parameter '".concat(name, "' for route '")).call(_context4, route, "'."));
    }
  });
