...
declare const createNamedContext: <T>(name: string, defaultValue?: T | undefined) => React.Context<T | undefined>;
/**
 ...
 */
declare const matchPath: (route: string, pathname: string, paramTypes?: Record<string, ParamType>) => {
    match: boolean;
    params?: undefined;
} | {
    match: boolean;
 ...
 *   => '/tags/code?extra=foo
 */
declare const replaceParams: (route: string, args?: Record<string, unknown>) => string;
 ...
 *
 */
declare function flattenSearchParams(queryString: string): Array<string | Record<string, any>>;
export { createNamedContext, matchPath, parseSearch, validatePath, replaceParams, isReactElement, flattenAll, flattenSearchParams, };
/**
